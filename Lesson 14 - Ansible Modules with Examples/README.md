...
![image](https://drive.google.com/uc?export=view&id=1zQVkyVGdD3UGEX3rHnrKtma3LQnwLIhl)
...
_**Note** : Difference between **script** and **shell** command module is that, when using **script** module, you don't need to copy the script to the remote machine, however you need to copy the script first to the target nodes (hence **task 3** is required) in case of **shell** module_
